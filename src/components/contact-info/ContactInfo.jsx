...
const ContactInfo = ({ data, website = "faridabad.com" }) => {
  ...
  return (
    <>
      ...
      <section
        id="contact-section"
        className="md:py-20 bg-[#f2e8e1] overflow-x-hidden px-4 sm:px-6"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">

            {/* ================= LEFT SIDE — FORM ================= */}
            <div className="bg-[#f2e8e1] p-4 md:p-8 rounded-2xl shadow-lg border border-[#422c18]">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="text-[#422c18] font-medium">
            ...
            {/* ================= RIGHT SIDE — INFO BOX ================= */}
            <div className="bg-[#f2e8e1] p-4 md:p-8 rounded-2xl shadow-lg border border-[#422c18] flex flex-col justify-center">
